...
if [ $p == none ]
then
  trpath=./data/datafiles/fsd50k_tr_full.json
else
...
CUDA_CACHE_DISABLE=1 python3 ./src/run.py --data-train $trpath --data-val ./data/datafiles/fsd50k_val_full.json --data-eval ./data/datafiles/fsd50k_eval_full.json \
--exp-dir $exp_dir --n-print-steps 1000 --save_model True --num-workers 32 --label-csv ./egs/fsd50k/class_labels_indices.csv \
